//GUI MODIFICATO CORRETTO DA FINIRE
...
public class GUI extends JFrame {
	...
	//variabili statiche aggiunge da Joi
	...
	private JPanel PanelMainArt,PanelMainNeg,panelFineMese,PanelTableOrdiniPrinc;
	...
	public GUI() throws ArticleDontExistInWareHouseException {
		...
		listaPanel.add(panelOrdini);
		listaPanel.add(PanelCreaNuovoOrd);
	...
	private void startGUI() throws ArticleDontExistInWareHouseException {
		...
		JPanel PanelTableOrdiniPrinc = new JPanel();
		...
		btnCreaNuovoOrd.addMouseListener(new MouseAdapter() {
			@Override
		...
		lblNegozio.setBounds(424, 242, 71, 14);
		PanelCreaNuovoOrd.add(lblNegozio);
		...
		comboBoxSel1.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		comboBoxSel1.setBounds(132, 31, 86, 20);
		CorniceArticoloLabel.add(comboBoxSel1);

		JComboBox comboBoxSel2 = new JComboBox();
		comboBoxSel2.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		comboBoxSel2.setBounds(132, 62, 86, 20);
		CorniceArticoloLabel.add(comboBoxSel2);

		JComboBox comboBoxSel3 = new JComboBox();
		comboBoxSel3.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		...
		comboBoxSel4.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		comboBoxSel4.setBounds(132, 124, 86, 20);
		CorniceArticoloLabel.add(comboBoxSel4);

		JComboBox comboBoxSel5 = new JComboBox();
		comboBoxSel5.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		...
		comboBoxSel6.setModel(new DefaultComboBoxModel(new String[] {"nome1", "nome2", "nome3", "nome4", "nome5", "nome6"}));
		...
		btnCrea.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (corriere.equals("") && corriere.equals(" ")) {//controllo che sia stato inserito un corriere valido
					...
					textCorriere.setBackground(Color.red);
					return;
				}
				...
				try {
					...
					if (articolo1.equals("<Articolo>") && qnt1 != 0) {
						...
						comboBoxSel1.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					if (articolo2.equals("<Articolo>") && qnt2 != 0) {
						JOptionPane.showMessageDialog(null, "Selezionare un articolo!");
						comboBoxSel2.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					if (articolo3.equals("<Articolo>") && qnt3 != 0) {
						JOptionPane.showMessageDialog(null, "Selezionare un articolo!");
						comboBoxSel3.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					if (articolo4.equals("<Articolo>") && qnt4 != 0) {
						JOptionPane.showMessageDialog(null, "Selezionare un articolo!");
						comboBoxSel4.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					if (articolo5.equals("<Articolo>") && qnt5 != 0) {
						JOptionPane.showMessageDialog(null, "Selezionare un articolo!");
						comboBoxSel5.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					if (articolo6.equals("<Articolo>") && qnt6 != 0) {
						JOptionPane.showMessageDialog(null, "Selezionare un articolo!");
						comboBoxSel6.setBackground(Color.red);
						voidSelection = true;
						return;
					}
					...
					if (modificaOrCreaOrdine == 2) {
						warehouse.setOrdine(indexOrder, o1);
					}
					...
					quantita1.setBackground(Color.red);
					quantita2.setBackground(Color.red);
					quantita3.setBackground(Color.red);
					quantita4.setBackground(Color.red);
					quantita5.setBackground(Color.red);
					quantita6.setBackground(Color.red);
				}finally {
					if (voidSelection) {
						return;
...
// */
		...
		btnUpdateArticolo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		...
		JLabel label_11 = new JLabel("Crea Nuovo Ingresso");
		label_11.setFont(new Font("Arial", Font.PLAIN, 30));
		label_11.setBounds(175, 13, 289, 35);
		panelNuovoIngresso.add(label_11);
		...
		JLabel lblQuantit1 = new JLabel("Quantit\u00E0");
		lblQuantit1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblQuantit1.setBounds(307, 127, 85, 16);
		panelNuovoIngresso.add(lblQuantit1);
		...
		JButton button1 = new JButton("Chiudi");

		button1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		button1.setBounds(232, 499, 145, 35);
		panelNuovoIngresso.add(button1);
	...
	private void fillTable(String type, DefaultTableModel model) {
		...
		case "ordini":
			...
			for(Ordine o : warehouse.getOrdineList()) {
				...
				model.addRow(new Object[]{o.getIDtoString(),o.getDataInString(),o.getTotalPrice(),o.getNegozio(),o.getCorriere(), o.getIfShipped(), o.getArticle()});
			}
